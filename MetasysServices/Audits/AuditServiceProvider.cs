...
namespace JohnsonControls.Metasys.BasicServices
{
    ...
    public sealed class AuditServiceProvider : BasicServiceProvider, IAuditService
    {
        ...
        /// <inheritdoc/>
        public async Task<PagedResult<Audit>> GetForObjectAsync(ActivityId objectId, AuditFilter auditFilter)
        {
            CheckVersion(Version);
        ...
        /// <inheritdoc/>
        public PagedResult<Audit> GetForObject(ActivityId objectId, AuditFilter auditFilter)
        {
