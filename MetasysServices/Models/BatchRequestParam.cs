...
namespace JohnsonControls.Metasys.BasicServices
{
    ...
    public class BatchRequestParam
    {
        ...
        /// <summary> 
        /// Activity Type. The possible values are: 'alarm', 'audit' 
        /// </summary>
        public string ActivityType { get; set; } = "";

        /// <summary> 
        /// Activity Management Status. The possible values are: 'discarded' (for Alarms and Audits), 'acknowledged' (for Audits) 
        /// </summary>
