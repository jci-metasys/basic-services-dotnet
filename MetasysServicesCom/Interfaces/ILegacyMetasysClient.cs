...
namespace JohnsonControls.Metasys.ComServices
{
    ...
    public interface ILegacyMetasysClient
    {
        ...
        object ReadPropertyMultiple([In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)]string[] objectIdList, [In, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] string[] propertyList);
