...
namespace MetasysServices.Tests
{
    ...
    {        
        ...
        public void TestGetNetworkDeviceAlarmsNone()
        {
            ...
            var alarms = client.Alarms.GetAlarmsForNetworkDevice(mockid.ToString(),new AlarmFilter { }); // No filter
        ...
        public void TestGetNetworkDeviceAlarmsOnePage()
        {
            ...
            var alarms = client.Alarms.GetAlarmsForNetworkDevice(mockid.ToString(), AlarmFilter);
            httpTest.ShouldHaveCalled($"https://hostname/api/v2/networkDevices/{mockid}/alarms")
                .WithVerb(HttpMethod.Get)
                .Times(1);
        ...
        public void TestGetNetworkDeviceAlarmsManyPages()
        {
            var response = @"{
            ""total"": 2,
            ""next"": ""https://win2016-vm2/api/v2/alarms?pageSize=1&excludePending=false&excludeAcknowledged=false&excludeDiscarded=false&page=2&sort=creationTime"",
            ""previous"": null,
            ""items"": [" + Alarm + @"],
        ...
        public void TestGetNetworkDeviceAlarmsWithType()
        {
            ...
            var alarms = client.Alarms.GetAlarmsForNetworkDevice(mockid.ToString(), new AlarmFilter { Type = 71 });
        ...
        public void TestGetNetworkDeviceAlarmsMissingItems()
        {
            ...
            Assert.Throws<MetasysObjectException>(()=>client.Alarms.GetAlarmsForNetworkDevice(mockid.ToString(), new AlarmFilter { }));
            httpTest.ShouldHaveCalled($"https://hostname/api/v2/networkDevices/{mockid}/alarms")
                .WithVerb(HttpMethod.Get)
                .Times(1);          
        }
        ...
        public void TestObjectAlarmMissingValuesThrowsException()
        {
            ...
            var e = Assert.Throws<MetasysObjectException>(() => // To do: Use Specific Exception for Alarm Item Provider
                client.Alarms.GetAlarmsForNetworkDevice(mockid.ToString(), new AlarmFilter()));
            httpTest.ShouldHaveCalled($"https://hostname/api/v2/networkDevices/{mockid}/alarms")
                .WithVerb(HttpMethod.Get)
                .Times(1);
